...
const Navbar = () => {
  ...
  return (
    <section className="flex justify-between items-center max-w-300 w-full mx-auto px-5 xl:px-0">
      <div>
        <img
          className="max-w-45 md:max-w-49 w-full my-4 md:my-0"
          src={navlogo}
          alt="Logo"
        />
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-4">
        ...
        <Button
          className="my-4.5 font-semibold hidden md:block"
          text="Get in Touch"
        />
        <button
